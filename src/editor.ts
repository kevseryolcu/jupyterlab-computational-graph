...
export
class ComputationalGraphWidget extends DocumentWidget<Widget> {
 ...
 */
export
class ComputationalGraphFactory extends ABCWidgetFactory<ComputationalGraphWidget, DocumentRegistry.IModel> {
    /**
    ...
    */
    ...
    protected createNewWidget(context: DocumentRegistry.Context): ComputationalGraphWidget {
        return new ComputationalGraphWidget({context, content: new Widget()});
    }
}
